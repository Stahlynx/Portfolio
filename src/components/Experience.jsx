    ...
    <div className='border-b border-neutral-900 pb-4 lg:mb-35'>
      ...
      <div className='py-4 lg:mb-35'>
        <div className="flex flex-wrap items-center justify-center gap-4">
          <div className="p-4">
            <img className="size-40" src="/kmb.png" alt="KMB ITB" />
          </div>
          <div className="p-4">
            <img className="size-40" src="/itbjazz.png" alt="ITBJazz" />
          </div>
          <div className="p-4">
            <img className="size-40" src="/hmif.jpeg" alt="HMIF ITB" />
          </div>
          <div className="p-4">
            <img className="size-40" src="/itb.png" alt="ITB" />
          </div>
        </div>
      </div>
      <div className=" flex bg-gradient-to-r from-transparent via-purple-900 to-transparent h-1 w-full "></div>
